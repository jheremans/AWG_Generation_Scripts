...
# times in ns
Chan1Val = [('125','numpy.cos(numpy.arange(-(numpy.pi),numpy.pi+.1,(numpy.pi)/8))'),('WFM_length-125','0')]
Chan1Mark1 = [('WFM_length','LOW')]
Chan1Mark2 = [('WFM_length','LOW')]

Chan2Val = [('125','numpy.sin(numpy.arange(-(numpy.pi),numpy.pi+.1,(numpy.pi)/8))'),('WFM_length-125','0')]
Chan2Mark1 = [('WFM_length','LOW')]
Chan2Mark2 = [('WFM_length','LOW')]

Chan3Val = [('125','numpy.cos(numpy.arange(-(numpy.pi),numpy.pi+.1,(numpy.pi)/8))'),('WFM_length-125','0')]
Chan3Mark1 = [('50','LOW'),('10','HIGH'),('WFM_length-60','LOW')]
Chan3Mark2 = [('WFM_length','LOW')]

Chan4Val = [('125','numpy.sin(numpy.arange(-(numpy.pi),numpy.pi+.1,(numpy.pi)/8))'),('WFM_length-125','0')]
...
base_filename = 'T_IQmodulation2SigGens_python'
os.chdir(base_dir)
