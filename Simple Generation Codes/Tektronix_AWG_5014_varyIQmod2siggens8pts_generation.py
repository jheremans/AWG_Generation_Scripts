...
theta_vals = numpy.arange(-(numpy.pi),numpy.pi+.1,(numpy.pi)/8)
cos_vals = numpy.cos(theta_vals)
sin_vals = numpy.sin(theta_vals)

# times in ns
Chan1Val = [('15','cos_vals[0]'),('15','cos_vals[2]'),('15','cos_vals[4]'),('15','cos_vals[6]'),('15','cos_vals[8]'),('15','cos_vals[10]'),('15','cos_vals[12]'),('15','cos_vals[14]'),('WFM_length-120','0')]
...
Chan2Val = [('15','sin_vals[0]'),('15','sin_vals[2]'),('15','sin_vals[4]'),('15','sin_vals[6]'),('15','sin_vals[8]'),('15','sin_vals[10]'),('15','sin_vals[12]'),('15','sin_vals[14]'),('WFM_length-120','0')]
...
Chan3Val = [('3','0'),('15','cos_vals[0]'),('15','cos_vals[2]'),('15','cos_vals[4]'),('15','cos_vals[6]'),('15','cos_vals[8]'),('15','cos_vals[10]'),('15','cos_vals[12]'),('15','cos_vals[14]'),('WFM_length-123','0')]
##[('125','numpy.cos(numpy.arange(-(numpy.pi),numpy.pi+.1,(numpy.pi)/8))'),('WFM_length-125','0')]
Chan3Mark1 = [('100','LOW'),('10','HIGH'),('WFM_length-110','LOW')]
Chan3Mark2 = [('WFM_length','LOW')]

Chan4Val = [('3','0'),('15','sin_vals[0]'),('15','sin_vals[2]'),('15','sin_vals[4]'),('15','sin_vals[6]'),('15','sin_vals[8]'),('15','sin_vals[10]'),('15','sin_vals[12]'),('15','sin_vals[14]'),('WFM_length-123','0')]
##[('125','numpy.sin(numpy.arange(-(numpy.pi),numpy.pi+.1,(numpy.pi)/8))'),('WFM_length-125','0')]
...
base_filename = 'T_varyIQmod8parts_python'
os.chdir(base_dir)
